...
class AdminController extends Controller
{
    ...
    private function validateCertificateRequest(Request $request, bool $includeAppointmentId = false): array
    {
        ...
        $messages = [
            ...
            'pet_age.regex' => 'Pet age must start with a letter or number and contain only letters, numbers, spaces, hyphens, and periods.',
            ...
            'owner_name.regex' => 'Owner name must start with a letter and can only contain letters, numbers, spaces, hyphens, apostrophes, and periods.',
            'owner_address.regex' => 'Address contains invalid characters.',
            'owner_phone.regex' => 'Phone number can only contain digits, +, -, (, ), and spaces.',
            'years_of_residency.regex' => 'Residency length must start with a letter or number and contain only letters, numbers, spaces, hyphens, and periods.',
